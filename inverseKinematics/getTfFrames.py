...
#Inverse Kinematics
import inverseKinematicsKlampt as inverseKinematicsKlampt
...
def geometry(x,y,z,human_limits=True):
    ...
    (' ""   ""   "../objects/sphere.off" "" "" "../objects/thincube.off" ""   ""   "../objects/sphere.off"'*(not human_limits))+"\n")
...
def get_link_pos(data):
    global link_poses,link_poses_found
    link_poses = [[],[],[],[]]
    for i in range(len(data.name)):
...
human_joint_robot_path = "inverseKinematics/IKwithKlampt/klampt/data/robots/new_rob.rob"
careObot_path = "inverseKinematics/IKwithKlampt/klampt/data/robots/careObot.rob"
